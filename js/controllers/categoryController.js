...
} from "../services/categorysservices.js";
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    init();  //este metodo permite cargar la categorias en la table
    ...
    form.addEventListener("submit", async(e) =>{
        ...
        try{
            ...
            //Si no hay id signifca que estamos agregando
            else{
                await createCategory(data);
            }
            modal.hide(); //Se oculta el form despues de agregar o actualizar
        ...
        async function loadCategories() {
            ...
            try{
                ...
                //Verificamos si no hay categorias
                ...
                categories.array.forEach((cat) => {
                    ...
                    tablebody.appendChild(tr); //Al tbody se le cocatena la nurvs fila creada
                });
